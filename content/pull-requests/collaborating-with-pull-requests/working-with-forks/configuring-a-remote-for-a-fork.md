---jameyrose/curl --request GET \ --url https://jameyrose.api-us1.com/api/3/accounts/id \ --header 'Accept: application/json'curl --request GET \ --url https://jtroseexpresstransport.api-us1.com/api/3/accounts/id \ --header 'Accept: application/json'
